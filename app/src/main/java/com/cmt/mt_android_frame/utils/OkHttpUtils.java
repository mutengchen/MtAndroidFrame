...
//
//                try {
//                    File compressFile = new Compressor(MyApplication.getContext()).compressToFile(file);
//                    Log.d(TAG, "buildReqeuestByHashmapWithImage: compressfile"+compressFile.getAbsolutePath()+"|"+compressFile.length());
//
//
