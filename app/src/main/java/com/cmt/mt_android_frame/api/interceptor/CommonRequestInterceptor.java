...
//        builder.addHeader("Authorization", "Bearer "+SharePreferencesUtils.getInstance().get(ConstValue.KEY.TOKEN,"") );
        // 构造请求头
...
//        String our_version = VersionUtils.getAppVersionName(MyApplication.getContext());
